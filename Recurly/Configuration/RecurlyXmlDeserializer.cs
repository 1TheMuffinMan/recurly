...
{
    /// <summary>
    /// Modified implementation of the RestSharp XmlDeserializer to work with Recurlys response schema
    /// </summary>
    public class RecurlyXmlDeserializer : IDeserializer
    {
        ...
        protected virtual object Map(object x, XElement root)
        {
            ...
            foreach (var prop in props)
            {
                ...
                if (type == typeof(RecurlyCurrency))
                {
        ...
        private object HandleListDerivative(object x, XElement root, string propName, Type type)
        {
            ...
            var attributes = t.GetAttribute<DeserializeAsAttribute>();
            if (attributes != null)
