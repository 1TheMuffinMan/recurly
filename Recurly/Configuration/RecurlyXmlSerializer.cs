...
namespace Recurly
{
    ...
    /// </summary>
    public class RecurlyXmlSerializer : ISerializer
    {
        /// <summary>
        /// Default constructor, does not specify namespace
        /// </summary>
        public RecurlyXmlSerializer()
        {
        ...
        public RecurlyXmlSerializer(string @namespace)
        {
            Namespace = @namespace;
            ContentType = "text/xml";
        }
        ...
        private void Map(XElement root, object obj)
        {
            ...
            foreach (var prop in props)
            {
                ...
                var skipNullAttribute = prop.GetAttribute<XmlSkipNull>();
                if (skipNullAttribute != null && prop.GetValue(obj, null) == null)
                    continue;
